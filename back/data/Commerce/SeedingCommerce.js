...
const fileStream = fs.createReadStream('/mnt/42BA76D5BA76C4C7/Téléchargements/shop_craft_office_csv/datajson.json', {encoding: 'utf-8'});
              ...
              if (
                ...
                value.type == 'tobacco' 
                    ...
                    if (value.X && value.Y && value.com_insee) {
                      ...
                      //console.log(value);
                      const {rows} = await db.query(`SELECT code_insee FROM private.commune WHERE code_insee='${value.com_insee}';`);
                      if (rows.length > 0 ) {
                         await db.query(
