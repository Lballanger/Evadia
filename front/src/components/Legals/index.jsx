...
const Legals = () => (
  <div className="legals">
    <div className="Legals__container">
      <div className="koho">
        <h1 className="Legals__h1">Mentions Légales</h1>
      </div>
      <div className="font-link">
        <h2 className="Legals__h2">Evadia</h2>
      </div>
      ...
      <p className="Legals__p">DigitalOcean</p>
      <p className="Legals__p">
        101 Avenue of the Americas 10th Floor New York, NY 10013 United States
      </p>
      <p className="Legals__p">1-347-903-7918</p>

      <h3 className="Legals__h3">Autres contributeurs :</h3>
      ...
      <p className="Legals__p">
        ...
        autorisation écrite préalable de l&apos;équipe de developpement. Toute
      ...
      <h3 className="Legals__h3">3 - Limitations de responsabilité.</h3>
      ...
      <p className="Legals__p">
        ...
        protection des données. Le cas échéant, se réserve également la
      ...
      <p className="Legals__p">
        ...
        données (type de données, finalité, destinataire…), il est également
        possible de déposer une réclamation auprès de la CNIL.
      </p>
