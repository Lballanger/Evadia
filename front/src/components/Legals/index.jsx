...
const Legals = () => (
  <div className="legals">
    <div className="About__container">
      ...
      <br />
      <br />
      <p className="About__p">Contact : evadia.apo@gmail.com</p>
      <h2 className="About__h3">Hébergeur :</h2>
      <br />
      <p className="About__p">DigitalOcean</p>
      <br />
      <p className="About__p">
        101 Avenue of the Americas 10th Floor New York, NY 10013 United States
      </p>
      <br />
      <p className="About__p">1-347-903-7918</p>

      <h3 className="About__h3">Autres contributeurs :</h3>
      ...
      <p className="About__p">
        Evadia est propriétaire des droits de propriété intellectuelle et
        ...
        préalable de l&apos;équipe de developpement.
        <br />
        <br />
      ...
      <h3 className="About__h3">3 - Limitations de responsabilité.</h3>
      ...
      <p className="About__p">
        ...
        disposition des utilisateurs.Evadia se réserve le droit de supprimer,
        ...
        échéant, se réserve également la possibilité de mettre en cause la
      ...
      <p className="About__p">
        ...
        Protection des Données : evadia.apo@gmail.com
        <br />
        <br />
        Pour plus d&apos;informations sur la façon dont nous traitons vos
        données (type de données, finalité, destinataire…),
        <br />
        Il est également possible de déposer une réclamation auprès de la CNIL.
      </p>
      <h3 className="About__h3">5 - Liens hypertextes et cookies</h3>
      <p className="About__p">
        ...
        enregistre des informations relatives à la navigation d’un utilisateur
        sur un site. Les données ainsi obtenues permettent d&apos;obtenir des
        ...
        durée maximale de mois.
        <br />
        <br />
        Pour plus d&apos;informations sur la façon dont nous faisons usage des
        cookies, lisez notre Politique de Confidentialité.
      </p>
